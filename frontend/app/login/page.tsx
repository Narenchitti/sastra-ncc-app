    ...
    <div className="relative min-h-screen w-full bg-[#080b06] overflow-hidden font-sans select-none">
      ...
      <div className="relative z-10 w-full min-h-screen flex flex-col items-center justify-center p-6 md:p-12 lg:p-16">
        <div className="max-w-4xl w-full flex flex-col md:flex-row items-center justify-center gap-10 lg:gap-12">
          ...
          {/* RIGHT: Login Card */}
          <div className="flex items-center justify-center w-full md:w-[50%] relative">
              ...
              <div className="p-8">
                ...
                <form action={clientAction} className="space-y-5">
                  ...
                  <div className="flex flex-col gap-1.5">
                    <label className="text-[10px] font-bold text-ncc-olive/80 uppercase tracking-widest font-sans flex items-center gap-1.5">
